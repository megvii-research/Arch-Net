...
import sys
sys.path.append("..")
from models.students.resnet18 import archnet_resnet18 as student_model_function
from models.teachers.resnet import resnet18 as teacher_model_function
...
parser = argparse.ArgumentParser(description="PyTorch BrigeNet-ResNet18 ImageNet Distillation")
...
parser.add_argument(
    ...
    default=8192,
    type=int,
    help="total number of training images per epoch",
)
...
parser.add_argument(
    "--number-of-middle-periods", default=24, type=int, metavar="N", help="number of the middle periods, except for the first and the last period"
)

parser.add_argument(
    "--output-path", type=str, default="../output_results/archnet_resnet18", help="a folder save training log"
)

parser.add_argument(
    "--teacher-model-path", type=str, default="../models/teachers/pretrained_models/resnet18-5c106cde.pth", help="path of the teacher model"
)
